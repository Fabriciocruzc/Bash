        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="page-header">
				...
				<div class="pull-right">
					...
					Listar</button></a>
					<a href="processa/proc_apag_turma.php?id=<?php echo $resultado["cod_turma"]; ?>"><button class="btn btn-sm btn-danger">
			...
			<form class="form-horizontal" method="post" action="processa/proc_edit_turma.php">
                        ...
                        <div class="form-group">
                          <label for="nome" class="col-sm-2 control-label">Nome Da Turma</label>
                           <div class="col-sm-6"> 
						   <input type="hidden" name="id" value="<?php echo $resultado['cod_turma']; ?>" >
                            <input name="nome" id="nome" type="text" class="form-control" 
							placeholder="Nome Da  Turma" value="<?php echo utf8_encode($resultado['nome_turma']); ?>" autofocus required />
                          </div>
                        </div><!--Form-Group-->
                              ...
                              <div class="col-sm-6">
                                <select name="escola" id="escola" class="form-control" required>
								  ...
								  <?php while($dados_instituicao = mysqli_fetch_array($consulta_instituicao)){ ?>
										<?php if( $resultado['instituicao_turma'] == $dados_instituicao['cod_instituicao']){?>
                              ...
                              <div class="col-sm-3">
                                <select name="turno" id="turno" class="form-control" required>
								  ...
								  <?php while($dados_turno = mysqli_fetch_array($consulta_turno)){ ?>
										<?php if( $resultado['turno_turma'] == $dados_turno['id']){?>
